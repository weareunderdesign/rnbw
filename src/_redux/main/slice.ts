...
import { TFile, TFileAction } from "@_types/main";
import { createSlice, PayloadAction } from "@reduxjs/toolkit";

import { TMainReducerState, TUpdateTreeViewStatePayload } from "./types";
...
export const MainReducer = undoable(slice.reducer, {
  ...
  groupBy: (action, currentState, previousHistory) => {
    return action.type === "main/increaseActionGroupIndex"
      ? currentState.actionGroupIndex - 1
      : currentState.actionGroupIndex;
  },
