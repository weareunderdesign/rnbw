...
export const  getPositionFromIndex = (editor: monaco.editor.IStandaloneCodeEditor,startIndex: number, endIndex: number)=> {
    ...
    const endPosition = editor.getModel()?.getPositionAt(endIndex as number + 1)
