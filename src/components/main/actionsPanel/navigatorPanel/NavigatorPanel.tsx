...
import { SVGIcon, SVGIconI } from "@_components/common";
...
const unsavedDarkProjectImg =
  "https://rnbw.company/images/favicon-dark-active.png";
const unsavedLightProjectImg =
                ...
                <>
                  <div className="gap-s align-center" onClick={onFileClick}>
                    <SVGIconI {...{ class: "icon-xs" }}>
                      {ffTree[file.uid].data.type == "html" &&
                      ffTree[file.uid].data.name == "index" &&
                      ffTree[file.uid].parentUid === "ROOT"
                        ? "home"
                        : filesReferenceData[
                            (
                              ...
                              1,
                              (ffTree[file.uid].data as TFileNodeData).ext
                                .length,
                            )
                          ] &&
                          (
                            ...
                            1,
                            (ffTree[file.uid].data as TFileNodeData).ext.length,
                          ) !== "md"
                        ? filesReferenceData[
                            (
                              ffTree[file.uid].data as TFileNodeData
